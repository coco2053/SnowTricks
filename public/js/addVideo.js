...
// Script pour ajouter des champs video.
...
$(document).ready(function() {
  ...
  if (index == 0) {
    ...
    // S'il existe déjà des video, on ajoute un lien de suppression pour chacune d'entre elles
  ...
  // La fonction qui ajoute un lien de suppression d'une video
